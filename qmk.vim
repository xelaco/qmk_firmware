...
387
normal! zo
let s:l = 232 - ((89 * winheight(0) + 14) / 28)
...
162
normal! zo
let s:l = 74 - ((9 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 74
...
badd +24 ~/qmk_firmware/keyboards/xelaco/niu_mini/keymaps/xelaco/keymap.c
