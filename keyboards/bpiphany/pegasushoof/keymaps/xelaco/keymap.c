...
{
  XELINIT = SAFE_RANGE, BATTLE1, BATTLE2, BATTLE3, BATTLE4, BATTLE5, BATTLE6, BATTLE7, BATTLE8, BATTLE9, XELSHOW, CTRL_FN
    /* Battleships
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [KM_XELQWERTY] = LAYOUT(
      ...
      CTRL_FN, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
      KC_QUOT,          KC_ENT,
  ...
  [KM_XELBATTLE] = LAYOUT(
      ...
      _______, _______, XELSHOW,                   MS_WHLD, MS_BTN3, MS_WHLU,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      _______, _______, _______,                   MS_BTN1, MS_UP,   MS_BTN2,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      _______, _______, _______,                   MS_LEFT, MS_DOWN, MS_RGHT,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
      _______,          _______,
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
