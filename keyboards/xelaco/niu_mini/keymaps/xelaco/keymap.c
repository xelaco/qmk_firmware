// cd && cd qmk_firmware/ && make xelaco/niu_mini:xelaco:dfu
// 2021 04 12
...
#define XC_SPAC LT(LAYER_RIGHT, KC_SPC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_BASE] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL, KC_CAPS, KC_LGUI, KC_LALT, LAYLEFT, KC_SPC,  XC_SPAC, KC_RALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
